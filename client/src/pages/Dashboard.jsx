      ...
      <div className="shadow py-4">
        <div className="px-5 flex justify-between items-center">
          <img
            ...
            alt=""
          />
          <div className="flex items-cxenter gap-3">
            <p className="max-sm:hidden">Wellcome Pallabit</p>
            <div className="relative group">
              ...
              <div className="hidden group-hover:block absolute top-0 right-0 z-10 text-black rounded pt-12">
                <ul className="list-none m-0 p-2 bg-white rounded-md border text-sm">
                  <li className="px-2 py-1 cursor-pointer pr-10">Profile</li>
